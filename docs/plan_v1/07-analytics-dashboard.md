...
│   │   ├── CorrelationMatrix.tsx     # D3.js heatmap
│   │   ├── LiquidityHeatmap.tsx      # D3.js quadrant
...
- [ ] Correlation matrix heatmap renders with correct color scale.
- [ ] Liquidity heatmap renders 4-axis quadrant.
