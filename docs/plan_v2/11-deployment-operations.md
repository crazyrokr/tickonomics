...
| v3      | Added QuestDB tiered storage (Proposal #1) and shared-memory Arrow IPC (Proposal #4) as deferred proposals. Added "QuestDB Tiered Storage Path" and "Shared-Memory Arrow IPC Path" runbooks (documentation only).                                                                      |
