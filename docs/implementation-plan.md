...
**Status: PARTIAL**
**Depends on:** Tracks 1 (DONE), 2 (PARTIAL), 3 (PARTIAL)
...
| NormalizationService | PENDING | Tiered Z-score lookback windows |
| IliCalculator | PENDING | Dynamic weight redistribution |
...
| SignalGenerator | PENDING | Percentile-rank thresholds |
