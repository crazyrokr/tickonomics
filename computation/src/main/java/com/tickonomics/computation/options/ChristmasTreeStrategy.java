...
public class ChristmasTreeStrategy extends BaseOptionStrategy {
    ...
    protected double calculateFormula(LegGroup legs) {
        double k1Mid = midPrice(legs.components().get(0));
        double k2Mid = midPrice(legs.components().get(1));
        double k3Mid = midPrice(legs.components().get(2));
        double k1 = legs.components().get(0).strike().doubleValue();
        double k2 = legs.components().get(1).strike().doubleValue();
        double k3 = legs.components().get(2).strike().doubleValue();
